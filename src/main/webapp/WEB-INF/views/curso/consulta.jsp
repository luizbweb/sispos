...
<html lang="pt-br">
  ...
  <div id="main"> <!-- Principal div que comporta o conteúdo do site -->
    ...
    <section>
    	<div id="div-consulta">
            <h3 class="consultatitulo">Consulta de Cursos</h3>
            <form id="form-consulta" method="post" action="curso">
                <input class="campo-consulta" type="text" placeholder="Digite o Curso ou o Código"/>
